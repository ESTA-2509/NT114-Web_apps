...
sql="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%1 - 500%') AND (`Price`=0);"
...
sql="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%500 - 5000%') AND (`Price`=0);"
mycursor.execute(sql)
...
sql="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%5000 - 50000%') AND (`Price`=0);"
mycursor.execute(sql)
...
sql="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%50000 - 5000000%') AND (`Price`=0);"
mycursor.execute(sql)
...
sql5="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%1 - 500%') AND (`Price`>0) AND (`Price`<=5);"
...
sql6="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%500 - 5000%') AND (`Price`>0) AND (`Price`<=5);"
...
sql7="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%5000 - 50000%') AND (`Price`>0) AND (`Price`<=5);"
...
sql8="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%50000 - 5000000%') AND (`Price`>0) AND (`Price`<=5);"
...
sql9="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%1 - 500%') AND (`Price`>5) AND (`Price`<=10);"
mycursor.execute(sql5)
...
sql10="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%500 - 5000%') AND (`Price`>5) AND (`Price`<=10);"
mycursor.execute(sql6)
...
sql11="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%5000 - 50000%') AND (`Price`>5) AND (`Price`<=10);"
mycursor.execute(sql7)
...
sql12="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%50000 - 5000000%') AND (`Price`>5) AND (`Price`<=10);"
mycursor.execute(sql8)
...
sql5="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%1 - 500%') AND (`Price`>10);"
mycursor.execute(sql5)
...
sql6="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%500 - 5000%') AND (`Price`>10);"
mycursor.execute(sql6)
...
sql7="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%5000 - 50000%') AND (`Price`>10);"
mycursor.execute(sql7)
...
sql8="select count(*) from `google_play_apps_data_sample_1` WHERE (`Downloads` LIKE '%50000 - 5000000%') AND (`Price`>10);"
mycursor.execute(sql8)
...
results = {
    ...
    'Under 5$': [Paid1_apps_1/all_Paid1_apps, Paid1_apps_2/all_Paid1_apps, Paid1_apps_3/all_Paid1_apps, Paid1_apps_4/all_Paid1_apps],
    'Under 10$': [Paid2_apps_1/all_Paid2_apps, Paid2_apps_2/all_Paid2_apps, Paid2_apps_3/all_Paid2_apps, Paid2_apps_4/all_Paid2_apps],
    'Over 10$': [Paid3_apps_1/all_Paid3_apps, Paid3_apps_2/all_Paid3_apps, Paid3_apps_3/all_Paid3_apps, Paid3_apps_4/all_Paid3_apps]
}
results1 = {
    'Free': [Free_apps_1, Free_apps_2, Free_apps_3, Free_apps_4],
    'Under 5$': [Paid1_apps_1, Paid1_apps_2, Paid1_apps_3, Paid1_apps_4],
    'Under 10$': [Paid2_apps_1, Paid2_apps_2, Paid2_apps_3, Paid2_apps_4],
    'Over 10$': [Paid3_apps_1, Paid3_apps_2, Paid3_apps_3, Paid3_apps_4]
}
...
file_name = 'bar_Chart_page_freevspaid.png'
